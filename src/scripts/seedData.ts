...
掌握这些用法，你的英语表达能力会大幅提升！`,
    image_url: getEducationalImage('grammar').url,
    image_alt: getEducationalImage('grammar').alt,
    published: true
  },
  {
...
掌握这些句型，你的SAT分数会有显著提升！`,
    image_url: getEducationalImage('study').url,
    image_alt: getEducationalImage('study').alt,
    published: true
  },
  {
...
6. 在你的论文/报告/research书面体现中写出结论`,
    image_url: getEducationalImage('analysis').url,
    image_alt: getEducationalImage('analysis').alt,
    published: true
  },
  {
...
掌握这些常用缩写，让你的学术交流更加准确高效！`,
    image_url: getEducationalImage('writing').url,
    image_alt: getEducationalImage('writing').alt,
    published: true
  }
]
...
const faqs = [
  ...
  },
  {
    ...
    category: 'payment',
    image_url: getEducationalImage('faq').url,
    image_alt: getEducationalImage('faq').alt,
    order_index: 2,
    published: true
  },
  {
